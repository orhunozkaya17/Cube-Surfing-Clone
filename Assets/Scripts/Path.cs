...
public class Path : MonoBehaviour
{
    ...
    public List<Vector3> CreatePath()
    {
       ...
       // }
        ...
        bezierObjList.Add(pathOBJList[pathOBJList.Count - 1].position);
        return bezierObjList;
    }
    public void pointchange(Vector3 point)
    {
        pathOBJList[0].position = point;
    }
    public Vector3 GetPoint()
    {
        return bezierObjList[0];
    }
